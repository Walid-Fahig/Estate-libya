  ...
  <!--******************************* header **********************************************-->
    <header>  
        <div class="topnav" id="myTopnav">
            ...
            <li><a href="signup.php"><strong>انشئ حساب جديد</strong></a></li>
    ...
    <!--********************************** Form login  **************************************-->
         <div> 
            <form method="post" action="mainEstateLibya.php" class="container">  
              <!-- display validation errors  here-->   
              <?php include('errors.php'); ?>
              <h1>تسجيل الدخول</h1>
             <label for="email"><b>اسم المستخدم</b></label>
             <input type="text" placeholder="اسم المستخدام" name="username">

             <label for="psw"><b>كلمة المرور</b></label>
             <input type="password" placeholder="ادخل كلمة المرور" name="password">
            
             <input type="submit" name="loginn"  value="تسجيل الدخول" class="btn" style=" background: #0eaaa6;">
            </form>
    </div>  
  <!--********************************* End Form login ************************************-->
